...
public class Spawner : MonoBehaviour
{
    ...
    public int TowerCost(int id)
    {
        switch (id)
        {
            case 0: return towersPrefabs[id].GetComponent<TowerGive>().cost;
            case 1: return towersPrefabs[id].GetComponent<TowerBarrier>().cost;
            case 2: return towersPrefabs[id].GetComponent<TowerAttack>().cost;
            default: return -1;
        }
    }
